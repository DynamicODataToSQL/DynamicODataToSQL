...
public class ODataToSqlFromRawSqlConverterTests(ITestOutputHelper output)
{
    private readonly ITestOutputHelper _output = output;

    [Theory]
    [MemberData(nameof(GetTestData))]
    public void ConvertToSQLFromRawSqlExpectedBehavior(
        string testName,
        string rawSql,
    ...
    private static ODataToSqlConverter CreateODataToSqlConverter() => new(new EdmModelBuilder(), new SqlServerCompiler() { UseLegacyPagination = false });
}
